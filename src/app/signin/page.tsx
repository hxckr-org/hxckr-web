...
export default function SignIn() {
  return (
    <div className="flex justify-between h-screen bg-grey-signin-background">
      ...
      <div className="flex flex-col items-center justify-center space-y-12 px-4 lg:px-16 h-full w-full lg:w-1/2 xl:w-1/3 bg-white text-black">
        ...
        <div className="flex flex-col items-center space-y-4 lg:space-y-8 w-full">
          ...
          <Button className="bg-grey-button-text text-black font-normal rounded-full border border-grey-button-border py-5 flex justify-center w-full lg:w-[442px] hover:bg-grey-button-border/50">
            <GithubIcon
              fill="black"
              props={{
