...
export const DashboardLayout = ({ children, session, className }: { children: React.ReactNode; session: Session; className?: string }) => {
  ...
  return (
    <div className='flex h-screen'>
      ...
      <div className='flex flex-col flex-1'>
        ...
        <div className={`bg-grey-button-text flex flex-col flex-1 overflow-y-auto text-black ${className}`}>{children}</div>
      </div>
    </div>
  );
};
